...
// Mouse
var mouseX, mouseY;
var presetCoords = [{ x: "0.29942857142857133", y: "0.021000000000000018" }];
...
// Render settings
const renderElement = window.getComputedStyle(
  document.getElementById("code-demo")
);
...
window.onresize = (ev) => windowResize();
...
function windowResize() {
  width = parseInt(renderElement.width.replace("px", ""));
  height = parseInt(renderElement.height.replace("px", ""));
